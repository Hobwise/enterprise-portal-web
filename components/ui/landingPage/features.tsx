    ...
    <section className='section'>
      <div ref={ref} className='content_div lg:content_div_small'>
        <Image
          ...
          alt='content'
          priority
          className='lg:h-[450px] object-contain absolute right-0 top-0'
        />
      </div>
    </section>
  );
...
export default function Features() {
  ...
  const contents = [
    ...
    },
    {
      ...
      description:
        'Engage your customers and grow your business with our intuitive marketing tools.',
      lists: [
    ...
    },
    {
      ...
      description:
        'From reservations to bookings, Hobwise makes it simple to manage everything in one place, ensuring your guests enjoy a smooth and welcoming experience, every time.',
      lists: [
        'Easily book available reservations, ensuring your spot is secured and ready for you.',
        'As a business owner, create and manage reservations',
      ],
      image: ContentImage4,
    },
  ];
      ...
      <Transition>
        <div className='lg:w-[65%] lg:mx-auto text-left lg:text-center px-6 lg:px-0'>
          <h2 className='text-[24px] lg:text-[40px] text-[#161618] lg:leading-[64px] font-bricolage_grotesque'>
            Unlock the Power of Hospitality with an All-in-One Management
            Platform
          </h2>
          <p className='font-normal text-[#44444A] lg:text-center lg:w-[80%] lg:mx-auto text-sm'>
            Transform how you manage your restaurant, hotel, or bar with
            Hobwise&apos;s comprehensive platform that integrates everything you
            need in one place.
          </p>
        </div>
      </Transition>
        ...
        <div className='px-6 lg:px-24 space-y-16 mt-8'>
          {contents.map((content, index) => (
            ...
            >
              ...
              <div
                className='w-[50%] flex'
                style={{ justifyContent: index % 2 ? 'start' : 'end' }}
              >
                <Transition>
                  <img
                    src={content.image.src}
                    alt='content'
                    className='h-[400px] object-contain justify-start'
                  />
                </Transition>
              </div>
            </div>
            ...
            <div className='grid grid-cols-1' key={content.title}>
              <div className='text-left w-full space-y-8'>
                <div className='space-y-4'>
                  <h4 className='text-[#101928] text-[24px] font-bricolage_grotesque rounded-lg w-fit'>
                    {content.title}
                  </h4>
                  <p className='text-[#808B9F] text-sm'>
                    {content.description}

  ...
  const tools = [
    {
      ...
      description:
        'Stay on top of things with up-to-date insights that empower you to make confident decisions for your business, no matter where you are.',
    ...
    },
    {
      ...
      description:
        'Whether you’re running a single venue or multiple locations, Hobwise makes it simple to manage reservations smoothly and keep your guests happy.',
    ...
    },
    {
      ...
      description:
        "Set up personalized notifications so you're always in the know about key moments and trends that affect your business—on your terms.",
    ...
    },
    {
      ...
      description:
        'With features like two-factor authentication and encrypted data, you can rest easy knowing your business and customer information is safe.',
    ...
    },
    {
      ...
      description:
        'Receive customized insights and helpful suggestions that are designed just for your business, helping you improve and grow effortlessly.',
        ...
        <Transition key={each.title}>
          <div
            ...
            style={{
              ...
              borderRadius: each.radius,
            }}
          >
            <div
              className={cn(
                'rounded-bl-[50px] rounded-br-[50px]  h-32 w-24 absolute right-0 top-0',
                index === 2 ? 'rounded-tr-[20px]' : 'rounded-tr-[0px]'
              )}

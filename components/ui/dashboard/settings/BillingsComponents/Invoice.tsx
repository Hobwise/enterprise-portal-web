        ...
        <article className="shadow-none md:shadow-md md:rounded-md overflow-hidden">
          <div className="md:rounded-b-md bg-white">
                ...
                <div className="flex justify-between items-top">
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      ...
                      <p>{moment(data?.subscriptionStartDate).format('DD/MM/YYYY')}</p>
                    </div>
                    <div>
            ...
            <table className="w-full divide-y divide-gray-200 text-sm">
              <thead>
                <tr>
                  <th className="px-9 py-4 text-left font-semibold text-gray-400">Item</th>
                  ...
                  <th className="py-3 text-left font-semibold text-gray-400">Discount</th>
                  <th className="py-3 text-left font-semibold text-gray-400"></th>
                </tr>
              </thead>

  ...
  const features: PlanFeature[] = [
    {
      ...
      value: plan.canAccessDashboard,
    },
    {
      key: "canAccessMenu",
      label: "Can Access Menu",
      value: plan.canAccessMenu,
    },
    {
      key: "canAccessOrders",
      label: "Can Access Orders",
      value: plan.canAccessOrders,
    },
    {
      key: "canAccessPayments",
      label: "Can Access Payments",
      value: plan.canAccessPayments,
    },
    {
      key: "canAccessSettings",
      label: "Can Access Settings",
      value: plan.canAccessSettings,
    },
    {
      key: "canAccessQR",
      label: "Can Access QR",
      value: plan.canAccessQuickResponses,
    },
    {
      key: "canAccessReservations",
      label: "Can Access Reservations",
      value: plan.canAccessReservations,
    },
    {
      key: "canAccessNotifications",
      label: "Can Access Notifications",
      value: plan.canAccessNotifications,
    },
    {
      key: "canAccessBookings",
      label: "Can Access Bookings",
      value: plan.canAccessBookings,
    },
    {
      key: "canAccessCampaigns",
      label: "Can Access Campaigns",
      value: plan.canAccessCampaigns,
    },
    {
      key: "canAccessReports",
      label: "Can Access Reports",
      value: plan.canAccessReports,
    },
    {
      key: "canAccessMultipleLocations",
      label: "Can Access Multiple Locations",
      value: plan.canAccessMultipleLocations,
    },
  ];

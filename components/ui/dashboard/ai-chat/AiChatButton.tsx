...
const AiChatButton = ({ onClick }: AiChatButtonProps) => {
  return (
    <button
      ...
      className="fixed bottom-24 right-6 z-40 flex h-16 w-16 items-center justify-center rounded-3xl bg-white p-[6px] shadow-custom_shadow ring-[3px] ring-primaryColor/10 transition-transform duration-200 hover:scale-105 active:scale-95"
    >

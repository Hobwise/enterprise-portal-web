          ...
          ? [
              {
                ...
                openingStock: parseFloat(current.openingStock as string) || 0,
                reorderLevel: parseFloat(current.reorderLevel as string) || 0,
                reorderQuantity: parseFloat(current.reorderQuantity as string) || 0,

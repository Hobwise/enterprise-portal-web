            ...
            try {
              ...
              const response = await createItemWithRecipe(businessId, {
                item: {
                  ...
                  itemType: itemType ?? 0,
                  strictnessLevel,
                  openingStock: parseFloat(openingStock as string) || 0,
                  reorderLevel: parseFloat(reorderLevel as string) || 0,
                  reorderQuantity: parseFloat(reorderQuantity as string) || 0,

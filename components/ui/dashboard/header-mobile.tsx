...
const HeaderMobile = () => {
  ...
  useEffect(() => {
    const handleMobileNavToggle = () => toggleOpen();
    window.addEventListener('hobwise:mobile-nav-toggle', handleMobileNavToggle);
    return () =>
      window.removeEventListener('hobwise:mobile-nav-toggle', handleMobileNavToggle);
  }, [toggleOpen]);

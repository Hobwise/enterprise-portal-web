...
//   const timeUntilRefresh = expirationDate - currentTime - 60000; // 60000ms = 1 minute
...
//     // Set up refresh schedule if tokenExpiration exists
//     if (userData.tokenExpiration && !refreshTimeout) {
...
//     // Keep the 401 handler as a fallback
//     if (
//       error.response &&
//       error.response.status === 401 &&
//       !originalConfig._retry
